...
def execute_null_hypothesis_simulations(study_map, cases, simulations_h0):
    ...
    for s in range(simulations_h0):        
        ...
        for unit in study_map.get_array_units():
            ...
            qLearning = QLearning(study_map=study_map_h0, unit=unit, episodes=episodes, steps=steps, alpha=alpha, gamma=gamma, epsilon=epsilon, verbose=False)
...
def execute_alternative_hypothesis_simulations(study_map, cases, label, cluster, simulations_h1, results_h0):
    ...
    for s in range(simulations_h1):        
        ...
        for unit in study_map.get_array_units():  
            ...
            qLearning = QLearning(study_map=study_map_h1, unit=unit, episodes=episodes, steps=steps, alpha=alpha, gamma=gamma, epsilon=epsilon, verbose=False)
...
def main():
    ...
    read_file = ReadFile(file_path=prefix_path+"Map_Model04.txt")
    ...
    cases = prefix_path+"Null_Hypothesis_Model04.txt"
    ...
    cases = prefix_path+"Cluster_A_Model04.txt"        
    ...
    cases = prefix_path+"Cluster_B_Model04.txt"
    ...
    cases = prefix_path+"Cluster_C_Model04.txt"
    ...
    cases = prefix_path+"Cluster_D_Model04.txt"
    ...
    cases = prefix_path+"Cluster_E_Model04.txt"
    ...
    cases = prefix_path+"Cluster_F_Model04.txt"
    ...
    cases = prefix_path+"Cluster_G_Model04.txt"
    ...
    cases = prefix_path+"Cluster_H_Model04.txt"
