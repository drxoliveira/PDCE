...
def execute_alternative_hypothesis_simulations(study_map, cases, label, cluster, simulations_h1, results_h0, file):
    ...
    mean, std = Resource.calc_detection_power(results_h0, results_h1, p_value=95)
    print(f"Power Mean: {mean}, Power Standard Deviation: {std}")
    
    file.write(f"Power Mean: {mean}, Power Standard Deviation: {std}")
    file.write("\n")

    mean, std = Resource.calc_ppv(study_map, results_h0, results_h1, simulations_h1, cluster, p_value=95)
    print(f"PPV Mean: {mean}, PPV Standard Deviation: {std}") 
    
    file.write(f"PPV Mean: {mean}, PPV Standard Deviation: {std}") 
    file.write("\n")

    mean, std = Resource.calc_sensitivity(study_map, results_h0, results_h1, simulations_h1, cluster, p_value=95)
    ...
    mean, std = Resource.calc_accuracy(study_map, results_h0, results_h1, simulations_h1, cluster, p_value=95)
    ...
    mean, std = Resource.calc_f_score(study_map, results_h0, results_h1, simulations_h1, cluster, p_value=95)
...
def main():
    ...
    file = open(prefix_path + "main_simulation_model04_mbpso20.txt", "w")

    read_file = ReadFile(file_path= prefix_path + "data/artificial/Map_Model04.txt")
    ...
    cases = prefix_path + "data/artificial/Null_Hypothesis_Model04.txt"
    ...
    cases = prefix_path + "data/artificial/Cluster_A_Model04.txt"      
    ...
    cases = prefix_path + "data/artificial/Cluster_B_Model04.txt"    
    ...
    cases = prefix_path + "data/artificial/Cluster_C_Model04.txt"    
    ...
    cases = prefix_path + "data/artificial/Cluster_D_Model04.txt"
    ...
    cases = prefix_path + "data/artificial/Cluster_E_Model04.txt"
    ...
    cases = prefix_path + "data/artificial/Cluster_F_Model04.txt"
    ...
    cases = prefix_path + "data/artificial/Cluster_G_Model04.txt"
    ...
    cases = prefix_path + "data/artificial/Cluster_H_Model04.txt"
