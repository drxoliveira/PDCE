class Solution:
    ...
    def __init__(self,                  
                 vertices=list(), 
                 variables=list(), 
                 scan_statistics_value=.0,                  
                 penalty_value=.0,
                 crowding_distance_value=.0,
                 scan_statistics_value_penalized =.0,
                 id_solution=0):   
        
        self.vertices = vertices  # array of vertices
        self.variables = variables # array of binary variables
        self.scan_statistics_value = scan_statistics_value #  scan statistics value
        self.scan_statistics_value_penalized = scan_statistics_value_penalized #  scan statistics value penalized
        self.penalty_value = penalty_value # function penalty value
        self.crowding_distance_value = crowding_distance_value # crowding distance computation value
        self.id_solution = id_solution # identifier solution 
    ...
    def set_crowding_distance_value (self, crowding_distance_value):
        self.crowding_distance_value = crowding_distance_value
    
    def get_crowding_distance_value (self):
        return self.crowding_distance_value
    
    def set_scan_statistics_value_penalized (self, scan_statistics_value_penalized):
        self.scan_statistics_value_penalized = scan_statistics_value_penalized
    
    def get_scan_statistics_value_penalized (self):
        return self.scan_statistics_value_penalized
    
    def set_id_solution(self, id_solution):
    ...
    def copy(self, solution):
        ...
        self.variables = solution.get_variables().copy()
        self.scan_statistics_value = solution.get_scan_statistics_value()
        self.penalty_value = solution.get_penalty_value()
        self.crowding_distance_value = solution.crowding_distance_value
        self.scan_statistics_value_penalized = solution.scan_statistics_value_penalized
...
class StudyMap:
    ...
    def __init__(self, 
                 ...
                 units_distance_list=list(), total_units=0, 
                 total_population=0, 
                 total_cases=0,
                 maximum_dispersion=.0):
        ...
        self.array_units = array_units                   # array of units
        self.maximum_dispersion = maximum_dispersion     # maximum_dispersion value
    ...
    def set_maximum_dispersion(self, maximum_dispersion):
        self.maximum_dispersion = maximum_dispersion

    def get_maximum_dispersion(self):
        return self.maximum_dispersion   
