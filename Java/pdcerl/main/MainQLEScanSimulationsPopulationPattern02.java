...
public class MainQLEScanSimulationsPopulationPattern02 {

    private static final int episodes = 1000;
    private static final int steps = 18;
    private static final double alpha = 0.6000;
    private static final double gamma = 0.0500;
    private static final double epsilon = 0.0040;
    ...
    public static void main (String [] args) {
        ...
        System.out.println("Simulations QLESCAN Artificial Clusters Population Pattern 04");
