...
public class MainEllScanSimulationsPopulationPattern02 {
    ...
    public static void executeAlternativeHypothesisSimulations(StudyMap studyMap, String fileCases, int numberSimulations,
        ...
        writerFile.createWriterFile("Power_Model04_" + label);
        ...
        writerFile.createWriterFile("Precision_Model04_" +  label);
        ...
        writerFile.createWriterFile("Recall_Model04_" +  label);
        ...
        writerFile.createWriterFile("Accuracy_Model04_" +  label);
        ...
        writerFile.createWriterFile("FScore_Model04_" +  label);
    ...
    public static void main (String [] args) {
        ...
        System.out.println("Simulations Scan Elliptic Artificial Clusters Population Pattern 04.");
